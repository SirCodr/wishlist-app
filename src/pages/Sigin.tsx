...
export default function SignInPage() {
  const { login, loginWitProvider } = useAuth()
        ...
        <CardContent className="space-y-4">
          <Tabs defaultValue="email" className="space-y-4">
            ...
            <TabsContent value="social" className="space-y-4">
              <Button variant="outline" className="w-full" onClick={() => loginProviderMutation.mutate('google')} disabled={loginProviderMutation.isPending}>
